    ...
    render(){
        ...
        return(
            <div>
                ...
                <DropdownList label='Oscillator Type' items={oscillatorList} setValue={this.props.setCurrentSelectedOscillator} value={this.props.trackOptions[foundIndex].currentSelectedOscillator}/>
